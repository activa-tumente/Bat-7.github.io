...
-- Agregar restricción CHECK a la columna rol si no existe
...
-- Crear o reemplazar la función update_ultimo_acceso
...
-- Otorgar permisos para ejecutar la función
GRANT EXECUTE ON FUNCTION public.update_ultimo_acceso(UUID) TO authenticated, service_role;

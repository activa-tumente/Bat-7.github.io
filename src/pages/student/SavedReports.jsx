    ...
    const fetchReports = async () => {
      try {
        ...
        if (error) {
          ...
          showToast('Error al cargar los informes guardados', 'error');
          return;
        }
            ...
            <Card>
              <CardBody>
                <div className="py-8 text-center">
                  ...
                  <Button as={Link} to="/student/results" className="mt-4">
                  ...
                  <Card key={report.id} className={`overflow-hidden shadow-lg border border-${reportColor}-200 hover:shadow-xl transition-shadow duration-300`}>
                    ...
                    <div className="bg-gray-50 px-4 py-3 border-t">
                      <div className="flex justify-between items-center">
                        <Button
                          as={Link}
                          to={`/student/informe-guardado/${report.id}`}
                          variant="primary"
                          size="sm"
                        >
                        ...
                        <div className="flex space-x-2">
                          <Button
                            onClick={() => window.open(`/student/informe-guardado/${report.id}`, '_blank')}
                            variant="outline"
                            size="sm"
                          >
